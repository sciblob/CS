...
// Read Zombie Plague Native And Forward
...
#define PLUGIN "[UNOFFICIAL CSO] MagnumBolt || ZP EXTRA +NATIVE"
#define VERSION "1.0"
...
// All Vars Here
new g_MaxPlayers, g_orig_event, g_item
...
public plugin_init()
{
	...
	g_item = zp_register_extra_item("Magnum-Bolt", 30, ZP_TEAM_HUMAN)
}
