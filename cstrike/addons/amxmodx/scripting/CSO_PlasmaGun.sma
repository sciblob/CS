...
#define PLASMA_SPEED 1200.0
#define PLASMA_RADIUS 78.0
...
public plugin_init() 
{
	...
	register_clcmd("say p", "Get_Plasma")
}

public plugin_natives ()
{
	register_native("give_weapon_Plasmagun", "Get_Plasmagun", 1)
}
public Get_Plasmagun(id)
{
	Get_Plasma(id)
}
